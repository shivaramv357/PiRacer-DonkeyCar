...
PCA9685_I2C_ADDR1 = 0x60     #I2C address, use i2cdetect to validate this number
...
STEERING_LEFT_PWM = 190         #pwm value for full left steering
STEERING_RIGHT_PWM = 520        #pwm value for full right steering
